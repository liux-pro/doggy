...
/* flags for lcd_setMemoryAccessControl(void); see (pdf v1.4 p142)
 *
 * For a description of how to use these flags,
 * see the documentation for the lcd_setMemoryAccessControl(void) function.
 */
...
/* arguments for lcd_setTearingEffectLine(void); see (pdf v1.4 p140) */
...
/* arguments for lcd_setGammaPredefined(void); see (pdf v1.4 p125) */
...
/* arguments for lcd_setInterfacePixelFormat(void); see (pdf v1.4 p150) */
...
/* MODIFICATIONS HERE HAVE TO BE ALSO MADE TO lcd_createSettings(void) FUNCTION! */
typedef struct lcd_t {
     ...
     * This variable is automatically set in lcd_createSettings(void).
     */
     ...
     * Used in lcd_setMemoryAccessControll(void) function.
     */
 ...
 *
 *   WARNING: lcd_setMemoryAccessControl(void) and lcd_setInterfacePixelFormat(void)
 ...
 */
lcd_ptr_t lcd_getSettingsActive(void);
 ...
 *   status code indicating success or failure
 */
lcd_status_t lcd_hardwareReset(void);
 ...
 *   status code indicating success or failure
 */
lcd_status_t lcd_softwareReset(void);
 ...
 *   status code indicating success or failure
 */
lcd_status_t lcd_activateMemoryWrite(void);
