...
//移植
extern void I2C_Write(uint8_t devAddr, uint8_t memAddr, uint8_t *dat, uint16_t size);
extern void I2C_Read(uint8_t devAddr, uint8_t memAddr, uint8_t *buf, uint16_t size);
